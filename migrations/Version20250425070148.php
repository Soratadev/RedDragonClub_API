 ...
 */
final class Version20250425070148 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
	 ...
	 ('Abstract Strategy','Abstract Strategy games are often (but not always): theme-less, without a storyline, built on simple and/or straightforward design and mechanics, perfect information games
       games that promote one player overtaking their opponent(s), little to no elements of luck, chance, or random occurrence'),
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql("SELECT SETVAL('category_id_seq', 1, false)");
